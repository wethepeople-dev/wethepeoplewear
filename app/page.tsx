      ...
      <div className="relative py-10 pt-14">
        <div className="">
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-10 md:px-20 mx-auto text-center mx-auto lg:text-left lg:w-6/12 lg:flex lg:items-center">
            ...
            <div className="w-full px-4 lg:w-6/12 mx-auto">
              <div className="lg:ml-auto text-center">
                <div className="relative z-10 inline-block pt-11 lg:pt-0 mx-auto">
                  <blockquote
